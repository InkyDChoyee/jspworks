	...
	<form action="joinProcess.jsp" method="post">
		<ul>
			...
			<li>
				...
				<input type="checkbox" id="hobby" name="hobby" value="영화" checked>영화보기
				<input type="checkbox" id="hobby" name="hobby" value="게임" checked>컴퓨터게임
			</li>
			<li>
				<label for="gender">성별 </label>
				<label><input type="radio" id="gender" name="gender" value="male" checked>남성</label>
				<label><input type="radio" id="gender" name="gender" value="female">여성</label>
			</li>
			<li>
				<textarea rows="3" cols="30" name="comment" placeholder="가입 인사를 남겨주세요"></textarea>
			</li>
